...
Use [docs/java-21-upgrade-report-template.md](../../../docs/java-21-upgrade-report-template.md) as the structural template when it fits the requested scope.
...
- [docs/java-21-upgrade-report-template.md](../../../docs/java-21-upgrade-report-template.md)
