...
## Purpose
Review Java source and build files, infer whether the codebase is closer to Java 5, Java 8, or a newer baseline, and recommend the most relevant changes needed to move safely toward Java 21.
...
- `report`: structured output suitable for review comments, tickets, or upgrade planning.
...
## Example Prompts
- `Review these Java files and recommend what should change to upgrade from Java 8 to Java 21`
- `Check whether this module looks like Java 5 or Java 8 code and suggest the right Java 21 migration path`
- `Find Java 21 upgrade blockers in this Maven project`
- `Recommend modern Java 21 replacements for legacy APIs in this package`
